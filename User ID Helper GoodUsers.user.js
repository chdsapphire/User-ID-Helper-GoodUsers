";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM55541327 - ищет встречу, хочет страстную женщину, готовую на множество экспериментов и готовую приводить подруг понятно для чего.   ";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
  ...
  (function() {
    ...
    let links = document.querySelectorAll("td a,p");
    links.forEach(function(link) {
    if (link.textContent.includes("CM38092830")) {
    let parent = link.parentElement;
    let newElement = document.createElement("div");
    newElement.innerHTML = "CM38092830  Joe - интересует встреча , живет в Словении работает очень много постоянно занятой , много путешествует. Можно предлагать  провести каникулы вместе.";
    newElement.style.display = "none";
    let button = document.createElement("button");
    button.innerHTML = "ℹ️";
    button.style.marginLeft = "5px";
  ...
  (function() {
    ...
    let links = document.querySelectorAll("td a,p");
    links.forEach(function(link) {
    if (link.textContent.includes("CM87531044")) {
    let parent = link.parentElement;
    let newElement = document.createElement("div");
    newElement.innerHTML = "CM87531044  Love - интересует дружба которая перерастет в любовь. Редко выходит на связь , но можно выманить тем что встреча в ближайшее время";
    newElement.style.display = "none";
    let button = document.createElement("button");
    button.innerHTML = "ℹ️";
    button.style.marginLeft = "5px";
  ...
  (function() {
    ...
    let links = document.querySelectorAll("td a,p");
    links.forEach(function(link) {
    if (link.textContent.includes("CM22917192")) {
    let parent = link.parentElement;
    let newElement = document.createElement("div");
    newElement.innerHTML = "CM22917192  Bobby Мужчина который уже не надеется ни с кем встретится на сайте но все же пишет и говорит про встречи. Была операция и за ним нужен уход пока он не восстановиться. Можно писать про встречу в аэропорту. И кажись он не против быть мастером доминантом .    ";
    newElement.style.display = "none";
    let button = document.createElement("button");
    button.innerHTML = "ℹ️";
    button.style.marginLeft = "5px";
  ...
  (function() {
    ...
    let links = document.querySelectorAll("td a,p");
    links.forEach(function(link) {
    if (link.textContent.includes("CM30189566")) {
    let parent = link.parentElement;
    let newElement = document.createElement("div");
    newElement.innerHTML = "CM30189566 Pram зустріч, обмін контактами";
    newElement.style.display = "none";
    let button = document.createElement("button");
    button.innerHTML = "ℹ️";
    button.style.marginLeft = "5px";
  ...
  (function() {
    ...
    let links = document.querySelectorAll("td a,p");
    links.forEach(function(link) {
    if (link.textContent.includes("CM63236122")) {
    let parent = link.parentElement;
    let newElement = document.createElement("div");
    newElement.innerHTML = "CM63236122 Bert (Albert) Контакти";
    newElement.style.display = "none";
    let button = document.createElement("button");
    button.innerHTML = "ℹ️";
    button.style.marginLeft = "5px";
  ...
  (function() {
    ...
    let links = document.querySelectorAll("td a,p");
    links.forEach(function(link) {
    if (link.textContent.includes("CM90815599")) {
    let parent = link.parentElement;
    let newElement = document.createElement("div");
    newElement.innerHTML = "CM90815599 Ross (Russ) Любить довгі листи, та багато порно, і зустріч";
    newElement.style.display = "none";
    let button = document.createElement("button");
    button.innerHTML = "ℹ️";
    button.style.marginLeft = "5px";
    ...
    (function() {
      ...
      let links = document.querySelectorAll("td a,p");
      links.forEach(function(link) {
      if (link.textContent.includes("CM76009825")) {
      let parent = link.parentElement;
      let newElement = document.createElement("div");
      newElement.innerHTML = "Зустрі, контакти";
      newElement.style.display = "none";
      let button = document.createElement("button");
      button.innerHTML = "ℹ️";
      button.style.marginLeft = "5px";
    ...
    (function() {
      ...
      let links = document.querySelectorAll("td a,p");
      links.forEach(function(link) {
      if (link.textContent.includes("CM12291224")) {
      let parent = link.parentElement;
      let newElement = document.createElement("div");
      newElement.innerHTML = "CM12291224 - контакти. Покупка його контактів через сайт";
      newElement.style.display = "none";
      let button = document.createElement("button");
      button.innerHTML = "ℹ️";
      button.style.marginLeft = "5px";
  ...
  (function() {
    ...
    let links = document.querySelectorAll("td a,p");
    links.forEach(function(link) {
    if (link.textContent.includes("CM596734")) {
    let parent = link.parentElement;
    let newElement = document.createElement("div");
    newElement.innerHTML = "CM596734 david Дуже релігійний, БЕЗ порно, хоче зустріч, та відносини, також повернутий на спорті  </br> CM596734  david Очень спокойный. Ищет встречу. Часто жалуется,что для него этот сайт дорогой, но можно его раскрутить на камшеер. Общение нейтральное. Можно поинтересоваться за службы в церкви и на этой теме поддержать разговор. Занимается спортом, так же он волонтер. Смотрит видосики.  ";
    newElement.style.display = "none";
    let button = document.createElement("button");
    button.innerHTML = "ℹ️";
    button.style.marginLeft = "5px";
  ...
  (function() {
    ...
    let parent = link.parentElement;
    let newElement = document.createElement("div");
    newElement.innerHTML = "CM12215097 Robert (Scott) Хоче реальну зустріч в його місті, плюс легка еротіка";
    newElement.style.display = "none";
    let button = document.createElement("button");
    button.innerHTML = "ℹ️";
    button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM94305926")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM94305926 - он ищет контакты + встреча, но может быстро слиться, если не держать постоянно на пазле. Остальное что было просто однодневки - написали и ушли, не знаю стоит ли что-то писать про них, т.к. инфа минимальная  </br> CM94305926 Брайан. Мужчина настроен на встречу. Любит порнушить. Но не против любовного общения. На камше придирчив к мелочам в сплите";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
  ...
  (function() {
    ...
    let links = document.querySelectorAll("td a,p");
    links.forEach(function(link) {
    if (link.textContent.includes("CM66841700")) {
    let parent = link.parentElement;
    let newElement = document.createElement("div");
    newElement.innerHTML = "Зустріч. Віповіда якщо писати що я їду в твою країну на роботу. Історія повинна бути логічноую, він часто повератаєтся до питань на які не дали відповіді. ";
    newElement.style.display = "none";
    let button = document.createElement("button");
    button.innerHTML = "ℹ️";
    button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM90764995")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM90764995 RON ( находится в San Jose ) - порнушник, общается только в чате, письма не пишет, говорит, что у него мало денег. Хочет встречи, но на встречу не давит, в основном только порно  ";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
  ...
  (function() {
    ...
    let parent = link.parentElement;
    let newElement = document.createElement("div");
    newElement.innerHTML = "Зустріч: Lidl on kings Road, - місце зустрічі. ";
    newElement.style.display = "none";
    let button = document.createElement("button");
    button.innerHTML = "ℹ️";
    button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM87571741")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "  CM87571741 Julian ( находится в Idaho Falls) - простое общение, порно его не интересует. Помешан на книгах, аниме. Любит фантастику. Хочет обменяться контактами и встретиться.  ";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
  ...
  (function() {
    ...
    let links = document.querySelectorAll("td a,p");
    links.forEach(function(link) {
    if (link.textContent.includes("CM17785308")) {
    let parent = link.parentElement;
    let newElement = document.createElement("div");
    newElement.innerHTML = " CM17785308 - зустріч і легке порно. Не просити його фото, або подивитись фото. Він ліва від цього.Відповіда якщо самому писати в чаті";
    newElement.style.display = "none";
    let button = document.createElement("button");
    button.innerHTML = "ℹ️";
    button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("C
) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "mike CM92316389 – живет в деревне где 400 человек, агрится когда говоришь что в его городе. Встреча, можно контакты пробовать";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM15463731")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM15463731 - не одобается тема порно.Скарга на інвай в чаті";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "❌";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM17623462")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM17623462 - особий статус. Сайт перевіря листи йому. Не писати відкрито про зустріч, контакти,порно.Використовувати метафори.";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "❌";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM86799341 - особий статус. Сайт перевіря листи йому. Не писати відкрито про зустріч, контакти,порно.Використовувати метафори.";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "❌";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM32073752 - особий статус. Сайт перевіря листи йому. Не писати відкрито про зустріч, контакти,порно.Використовувати метафори.";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "❌";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "мужчина сказал сайту, что девушка нереальная.потому что девушка недействительно будет вне сайта связыаться";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "❌";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM67648987")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "не писати про зустріч";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "❌";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "високе очікування швидкості доставки листів - відповідати на листи асап";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "⚡️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM42454759")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM42454759 Rene - часто видаляє профайл , порнушник, дивиться фото, був в Україні раніше, колишня дружина від якої дитина - з Запоріжжя";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM21562195")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM21562195  Anthony - флорист і романтик, довгі відносини шукає, останнім часом не буває на сайті, дивиться фото і віде";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM97218312 ThomasKeith - хоче зустріч, об'ємні листи, був часто в Україні до війни, знає трішки російську";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM18728066")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM18728066 Tom - новий на сайті, текстові чати, дивить фото, шукає серйозні відносини, молодий романтик, не порнушник, обмін контактами";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM42969355")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM42969355 Alfred - хоче зустріч, після першого переносу зустрічі не відповідає взагалі";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
  ...
  (function() {
    ...
    let parent = link.parentElement;
    let newElement = document.createElement("div");
    newElement.innerHTML = "CM97159018 Richard - порнушник, має довгі відносини на цьому сайті з іншою українкою, але хоче розваг на стороні, не проти тріо, дивить фото і відео доки зацікавлений, хоче зустріч тільки заради сексу";
    newElement.style.display = "none";
    let button = document.createElement("button");
    button.innerHTML = "ℹ️";
    button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM75667454")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM75667454  Ar - романтик, хоче відносини, без треша, без порно, просто листування, інколи текстові чати, фото і відео не дивиться";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM11833662 MICHAEL - збоченець, небайдужий до маленьких дівчат, дивить фото і відео поки зацікавлений, порнушник, зустріч хоче, а в майбутньому, колись";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM89537966")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM89537966 Luis - хоче відносин, не принципіальний, готовий до відносин з декількома дівчатами, на подарунки не ведеться, на чати також, рідке листування, не часто чита";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM13882543")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM13882543 Reginald любит самодостаточных дам , живет в Лондоне можно брать на встречу и на то что можно с ним сьездить на отдых";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM19822482")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM19822482 Ronie Он работает в отеле охранником. Не любит порно в начале но не против позже поговорить о легкой эротики, пишет несколько раз в неделю и просить что бы писали только в ответ на его письма.";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM97159018 Richard. Аризона. Он Рентгенолог. Сейчас на пенсии. Развёлся в 2000 году. У него два сына 26 и 28 лет. Темы общения: Порно/любовь. Ему нравится быть рабом. Активный на камшер, если уговорить. ";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM26811672 George. Pennsylvania. Дом находится рядом с Атлантическим океаном, Чесапикским заливом и заливом Делавэр.  дал присягу в качестве кадета в Академии береговой охраны США – самой маленькой в   стране военной академии. Идёт на Любовь/порно. Не затрагивайте с ним тему лесби! Активный на камшер, если уговорить. (Имеет проблемы со слухом).";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM27035717")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM27035717 Jhon - обмін контактами";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM63735692 Jim (Gijs) - просте спілкування за життя, також обмін контактами та можлива зустріч. Грошей нема, термін спілкування короткий";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM83738882")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM83738882 James - зустріч в США, хоче контакти , грошей не має, нікому не вірить";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM1310941")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM1310941 carl - Живе в Монтерей, США, є діти, бізнесмен,  листи не читає";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM84149057")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM84149057 Timothy - нещодавно на сайті, читає всі листи, але не відповідає майже ніколи";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM30682999")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM30682999 Devon - молодий пацан, хоче мілфу, хоче зустріч в Кентукі, та хоче снепчат";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM27292219")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM27292219 Thomas - багато порно будь якого масштабу, зустріч в його місті zizers, довгі текстові чати про зустріч та секс";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM13395105 Clay, жесткий порнушник, ведется на тройник и пошлые фантазии, читает письма";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM77013018")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM77013018 Morgan, не особо верит в любовь онлайн, ведется на встречу и обмен контактами ";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM70241815 Rodwin, живёт в Гонолулу, не против встречи, вежливый";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM88481291 Colum; Открывает фото. Хочет серьезные отношения. Его не интересуют интим переписки. Ведеться на обмен контактами и встречу. Передает свою инфу, живет на три страны: Кипр, Швейцария(Женева), Хорватия (Дубровник). Работает в Женевской школе дипломатии. Готов покрыть все расходы на приезд к нему... Ему не интересны отношения по переписке, только встреча. Просит позвонить в его университет, где он работает.";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM97047799")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM97047799 Steve; Его привлекает индивидуальная внутренняя красота... У него недавно была операция. Цепляет встреча";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM70241815 Rodwin; Интересует встреча на Гаваях, можно остановиться у него";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM59675487")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM59675487 Aurelien; Хочет жену, которая его будет слушаться и будет верной. Он хочет секс, поэтому хочет как можно скорее жениться...";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  links.forEach(function(link) {
  if (link.textContent.includes("CM65699094")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM65699094 Marian; Поляк, ищет любовь, не против сексуальных фантазий, но стеснительный... Хочет передачу контактов.";
  newElement.style.display = "none";
...
(function() {
  ...
  links.forEach(function(link) {
  if (link.textContent.includes("CM86970968")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM86970968 Jamie; Хочет серьезных отношений, длительных, хочет жену. Он потерял свою жену три года назад из-за болезни Альцгеймера. Живет в Пойнтоне. Хочет встречу за чашкой кофе... Не хочет тратить время на этом сайте.";
  newElement.style.display = "none";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM56104779 Sammy; Хочет встречу, улетает в командировку на месяц в Южную Америку";
  newElement.style.display = "none";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM27709781  JIONG SONG ; Відповіда на зустріч в Montréal. Ведется якщо написати відкрите публічне місце, по типу госпіталя. Може навіть туди приїхати. Хоче зустріч і не витрачати гроші на сайті. Тому можно грати в ігри з обміном контактами. Треба бути обережним тому що він звертается на сайт. ";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "❌❌❌";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM64111083")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "Відповіда на зустріч. Може перевірити адрессу. ";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "❌";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM1239829")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = " My birth name was Jorge Santiago, but I was adopted and my name was changed from that to George Rivera. ";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "❌";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "Обмін контактами через 20 листів.Порно. Термін спілкування 2 тиждня. </br> –  Хочет трисом, не верит если говорить, что девушка собирается в его город, лучше быть где-то рядом, за контакты не надо ";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "– Мужик гарем хочет, обращаться к нему Мастер, если начнет выендриваться, не смотрит фотки и хочет, чтобы фотки в письмах были максимально отфотошопленные. общаться без камеры, бо он бомжик </br> 1.США, город Портедж, Висконсин.2. Ларри.4. Ищет семью состоящую из девушек рабынь, которые будут удовлетворять мастера. Любит порно..5. Что не любит что лучше не упоминать.  Дает тупые правила в начале общения, которые нужно соблюдать. Ненавидит фото, общение камшеер призирает. Нельзя перечить ему.6. Слабые // сильные места Общается в чате, очень редко пишет письма, но по началу читает письма, иногда может отправить подарок.";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM16927058")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "Зустріч The Hilton garden inn ";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM80375577")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "Зустріч контакти. Подобаются пазли. В нього є ФБ colin Ball ";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM30444289")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "Контакти. Номер телефону: 004478973 ";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "– Balken Встреча, контакты НЕ надо, на камшеер НЕ выходит, можно звонки, но аккуратно </br> CM15189255  Balken Ждет встречу. С ним можно спокойно поддерживать общение, но может часто забывать информацию, которую мы даем. Может пропасть на несколько дней из-за семьи. Ему нравятся романтичные письма, где красиво описано в будущем. В чат можно не звать.";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = " Зустріч. Він релегійний.The meeting place is the Saban Temple   ";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = " - Обмін контактами.Жре листи що йобнутий. </br> – 1. David, Настоящее имя Мадубуэзе Нвозо/Madubueze Nwozo2. Живет в Нэшвилл, работает в штате Теннеси3. +161583831574. Хочет съебать с сайта, любовь + порно ( хочет много секса )5. Да в принципе опенмайнд.6. Деньги, может слиться в любой момент. </br> - Обмін контактами.Жре листи що йобнутий. </br> – 1. David, Настоящее имя Мадубуэзе Нвозо/Madubueze Nwozo2. Живет в Нэшвилл, работает в штате Теннеси3. +161583831574. Хочет съебать с сайта, любовь + порно ( хочет много секса )5. Да в принципе опенмайнд.6. Деньги, может слиться в любой момент. ";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM80080215 Philip Встреча/контакты. Ищет долгосрочные отношения. Простой терпеливый мужик. Обычный, без каких-то ярко выраженных фетишей. Пока что ничего больше эротики не было, не уходит в тему порно. Может иногда делать чаты и смотреть фотки, хорошо читает письма и часто пишет сам. </br> - Philip.Ренфрю, Онтарио, Канада.Заинтересован в контактах и встрече.  Хорошо читает письма с паззлом. Пока что мало информации.";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM66993224")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM66993224 Kevin Мужчина ищет любовь всей своей жизни. Ведется на встречу.Он никогда не был женат, и уже не надеется найти кого-то своей жизни. Живет скучной обыденной жизнью дом-работа..";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM80723339")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM80723339  jesper любов і романтика, без порно!Живе в  Данії, Сківе, розведений. Живе з сином, дочки з жінкою. Вони приїздять до нього на вихідні.";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM54702846")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "Порно, болеет раком кожи не заходит на сайт";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM46062950")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = " CM46062950 обмін контактами: lonnyjohnston348is в скайпі ";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM38430920")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "Зустріч adress: Frits, Linåtoften 18, 1. th., 7451 Sunds!";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM41498165 David Жирный мужик,смотрит медийку всю.Но верующий. не любит порно.Ищет не слишком молодую даму. </br> </br> - David/ CM41498165 Общение, встреча. У девушки должны быть хорошие взгляды на жизнь. Ищет  по большей части друга а не девушку. <br> – David Возможны встречи, никаких обмен контактами, никакого порно.";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "Victor - імпотент, тому має ділдо та страпони шоб задовольняти жінку, може довго на цьому спілкуватись </br> – Victor Tores. Austin, US. Мужчину интересует встреча и порно.В нього багато секс іграшок котрими він буде кохати жінку. В чат выходит только при упоминании скоро встречи.Ведется на обмін контактами. Общается в чате на любые темы";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️ ";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM45559604 встречу как можно скорее, без драмы и переносов, помогает семьям </br>Vikesh CM45559604 встреча, письма хорошо читает , чаты короткие, хочет несколько жен .Он Дева и не любит драмы.";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️ ";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let links = document.querySelectorAll("td a,p");
  links.forEach(function(link) {
  if (link.textContent.includes("CM98885192")) {
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "Порно,мама донька,сестри";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️ ";
  button.style.marginLeft = "5px";
...
(function() {
  ...
  let parent = link.parentElement;
  let newElement = document.createElement("div");
  newElement.innerHTML = "CM37931634	David   хочет встречи.Любит общение про любовь и немного порно </br> CM37931634 David  хочет встречи.Любит общение про любовь и немного порно";
  newElement.style.display = "none";
  let button = document.createElement("button");
  button.innerHTML = "ℹ️ ";
  button.style.marginLeft = "5px";
